...
double* SteepestTangent(const uint8 *Image, const size_t  Nr, const size_t  Nc) {
  /* 
     This implements the basic Steepest Up Tangent Algorithm.
     Loops over all other pixels and remembers the greatest slope.
     Paul @ 09 July 2018.
     Allocates memory for a double precision image, fills it with the
     Steepest Up Tangent and returns a pointer to it.
  */
/***********************************************************************/
